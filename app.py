...
st.markdown("""
    <style>
        ...
        /* ------------------------------------------------------------- */
        /* ครอบคลุมทั้ง NumberInput, SelectBox และ TextInput (หน้า Login) */
        ...
        div[data-baseweb="base-input"] input {
            ...
            -webkit-text-fill-color: #38bdf8 !important; /* ป้องกัน Browser Override */
        }

        /* เปลี่ยนสีไอคอน Dropdown, Calendar และรูปตา (Password) ให้เป็นสีฟ้าเรืองแสง */
