...
st.markdown("""
    <style>
        ...
        /* สไตล์หน้าจอศูนย์ปฏิบัติการ (Holographic Grid) */
        .stApp { 
        ...
        /* ฟอนต์ตัวเลขแบบโปรแกรมเมอร์ */
        .tech-font {
            font-family: 'JetBrains Mono', monospace !important;
            letter-spacing: -0.5px;
        }

        /* Glassmorphism ขั้นสูง + แอนิเมชันขอบเรืองแสง */
        ...
        /* --------------------------------------------------- */
        /* อัปเกรด: แท็บเมนูสไตล์ Floating HUD (ลบเส้นใต้เดิมทิ้ง) */
        /* --------------------------------------------------- */
        ...
        /* ซ่อนขีดเส้นใต้สีแดง/ฟ้า เดิมของระบบ */
...
# ==========================================
# 2. ENCRYPTED DATABASE ARCHITECTURE
# ==========================================
